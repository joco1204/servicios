...
$vacio=0;
		...
		$tituloReporte = "REPORTE REGISTROS PASO 2";
		
		$titulosColumnas = array('ID CLIENTE','NOMBRE','CELULAR','BACKOFFICE','OBSERVACION','FECHA PASO 1');
		...
		header('Content-Disposition: attachment;filename="ReporteBack2.xlsx"');
