...
<head>
    ...
    <section class="page container">
        <div class="row">
			...
			<?php
			$sqlemp = "SELECT * FROM crmpa_empresa";
			//$array = array();
			$nemp=0;
			...
			<div class="span4">
                <div class="box pattern pattern-sandstone">
                    ...
                    <div class="box-content box-list collapse out" id="<?php echo "cmpy".$nemp;?>">
                        <ul>
							<?php
							$sqlser = "SELECT * FROM crmpa_servicio where emp_id=".$row_emp['id'];
							foreach($pdo->query($sqlser) as $row_ser){
                            ?>
							<li>
								<a href="connect.php?idserv=<?php echo $row_ser['id_serv'];?>&pdate=<?php echo $pdate;?>" class="news-item-title">
									<?php echo $row_ser['servicio'];?>
								</a>
                            </li>
                            <?php
							}
