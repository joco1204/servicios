...
<form class="form-horizontal">
  <div class="table-responsive">
    <table class="table table-bordered table-striped table-highlight">
		<tbody>
        <tr>
			<th colspan="4"><div class="badge badge-info" width="100%"> BACK-OFFICE PASO 3:</div></th>
		</tr>
		<tr>
			<td>FECHA DE RECIBIDO:</td>
			<td><input type="date" class="form-control" id="fecha_recibido_mod3" value="<?php echo $today;?>" /></td>
		
			<td>NOMBRE DEL USUARIO QUE TOMO LA FICHA:</td>
			<?php echo '<td><input type="text" class="form-control" id="back_mod3" value="'.$_SESSION['nombre'].'" readonly /></td>'; ?>
		</tr>
		<tr>
			<td>OBSERVACIONES</td>
			<td colspan="3">
				<textarea id="obs_mod3" style="width:98%;" class="form-control" onKeyUp="aMayusculas(this.value,this.id)"></textarea>
			</td>
		</tr>
		<tr>
	...
	<table class="table table-bordered table-striped table-highlight">
		...
		<tr>
			...
			<td>
			<input type="" value="<?php echo $row['nline']; ?>" readonly />
			</td>
		</tr>
		<tr>	
			<th colspan="4">
		...
		<tr>
			<td colspan="4">
				<?php echo '<div id="'.$nlinea.'" name="'.$nlinea.'" class="collapse">';?>
					...
					<!-- -->
					<?php 
					$sqllines_back = "SELECT * FROM crmgest_back1 where id_modulo=".$row['id_modulo']." and linea=".$i;
					
					foreach($pdo->query($sqllines_back) as $rowback){
					?>
						<table>
						<tr>
							<th colspan="4"><div class="badge badge-info" width="100%">BACK-OFFICE</div></th>
						</tr>
						<tr>
							<td># SIM AVANTEL</td>
							<td><input type="" value="<?php echo $rowback['sim']; ?>" readonly /></td>
							<td># EVIDENTE</td>
							<td><input type="" value="<?php echo $rowback['evidente']; ?>" readonly /></td>
						</tr>
						<tr>
							<td># ASIGNADO</td>
							<td><input type="" value="<?php echo $rowback['asignado']; ?>" readonly /></td>
							<td># ANEXO</td>
							<td><input type="" value="<?php echo $rowback['anexo']; ?>" readonly /></td>
						</tr>
					...
					?>
						<tr>
							<td># OPORTUNIDAD</td>
							<td><input type="" value="<?php echo $rowback['oportunidad']; ?>" readonly /></td>
							<td># COMPRA</td>
							<td><input type="" value="<?php echo $rowback['compra']; ?>" readonly /></td>
						</tr>
						<tr>
							<td># COTIZACION</td>
							<td><input type="" value="<?php echo $rowback['cotizacion']; ?>" readonly /></td>
							<td># FCA</td>
							<td><input type="" value="<?php echo $rowback['fca']; ?>" readonly /></td>
						</tr>
						<tr>
							<td># FCE</td>
							<td><input type="" value="<?php echo $rowback['fce']; ?>" readonly /></td>
							<td></td>
							<td></td>
						</tr>
						</table>
					...
					<table >
						...
						<tr>
							 ...
							 <td colspan="2"><input type="" value="<?php echo $row[$obs]; ?>" readonly /></td>
