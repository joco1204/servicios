...
<form class="form-horizontal">
  <div class="table-responsive">
    <table class="table table-bordered table-striped table-highlight">
		<tbody>
        <tr>
			<th colspan="4"><div class="badge badge-info" width="100%"> BACK-OFFICE PASO 1:</div></th>
		</tr>
		<tr>
			<td>FECHA DE RECIBIDO:</td>
			<td><input type="date" class="form-control" id="fecha_recibido_mod1" value="<?php echo $today;?>" /></td>
		
			<td>NOMBRE DEL USUARIO QUE TOMO LA FICHA:</td>
			<?php echo '<td><input type="text" class="form-control" id="back_mod1" value="'.$_SESSION['nombre'].'" readonly /></td>'; ?>
		</tr>
		<tr>
			<td>OBSERVACIONES</td>
			<td colspan="3">
				<textarea id="obs_mod1" style="width:98%;" class="form-control" onKeyUp="aMayusculas(this.value,this.id)"></textarea>
			</td>
		</tr>
		<tr>
